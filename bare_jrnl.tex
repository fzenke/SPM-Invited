...
% TODO here could be the logical entry point for some of the spatial and temporal credit assignment intro that Emre has written in the end
...
However, in the spiking neuron case several important issue arises
...
\subsection{Challenges of gradient-based learning with spiking neurons}
...
% under construction, fzenke
Both challenges relate to the first challenge concerns the lack of differentiability of the spiking architecture itself. 
...
One of the first uses of \gls{sg} is described in
...
% TODO write section.
% Here is what Emre had in mind: Basically using BPTT to train  spiking neural networks. I remember you had some suggestions. Alternatively we can just summarize Slayer / spiking LSTM.
