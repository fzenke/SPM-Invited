...
\begin{infobox}
  \begin{mdframed}[backgroundcolor=black!10]\small
    \textbf{The Gradient Backpropagation Rule:} The task of learning is to minimize this cost over the entire dataset.
...
\begin{infobox}
  \begin{mdframed}[backgroundcolor=black!10]\small
    \textbf{Non-local Models of Computation:} Locality of computations is characterized by the set variables available to the physical processing elements, and depends on the computational substrate.
